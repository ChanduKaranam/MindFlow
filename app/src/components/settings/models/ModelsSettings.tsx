          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              ...
              <div className="relative" ref={languageDropdownRef}>
                <button
                  ...
                  className={`flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium rounded-lg transition-colors ${
                    languageFilter !== "all"
                      ...
                      : "bg-surface-high text-text/60 hover:bg-surface-high/70"
                  }`}
                >
                ...
                {languageDropdownOpen && (
                  <div className="absolute top-full right-0 mt-1 w-56 bg-background border border-border rounded-lg shadow-lg z-50 overflow-hidden">
                    <div className="p-2 border-b border-border/50">
                      <input
                        ...
                        className="w-full px-2 py-1 text-sm bg-surface-high border border-border/50 rounded-md focus:outline-none focus:ring-1 focus:ring-accent"
                      />
                    </div>
